...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      {/* Cinematic overlays */}
      <div className="absolute inset-0 bg-gradient-to-b from-noir/70 via-noir/25 to-noir/90" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center sm:items-start sm:justify-end h-full px-6 sm:px-12 md:px-20 pb-16 sm:pb-32 max-w-[1400px] mx-auto text-center sm:text-left">
        <div
          ...
          style={{
            animation: "lineExpand 1.2s cubic-bezier(0.22, 1, 0.36, 1) 0.4s both",
            transformOrigin: "center",
          }}
        />

        <h1
          className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-cream leading-[1.05] tracking-tight max-w-4xl"
          style={{ animation: "heroTextReveal 1.4s cubic-bezier(0.22, 1, 0.36, 1) 0.6s both" }}
        >
          Your love story,
          <br />
        ...
        <p
          className="mt-6 sm:mt-8 text-cream/60 text-sm sm:text-base md:text-lg font-sans font-light max-w-lg leading-relaxed"
          style={{ animation: "heroTextReveal 1.4s cubic-bezier(0.22, 1, 0.36, 1) 0.9s both" }}
        >
        ...
        <div
          ...
          style={{ animation: "heroTextReveal 1.4s cubic-bezier(0.22, 1, 0.36, 1) 1.2s both" }}
        >
          <button
            onClick={open}
            className="text-[12px] sm:text-[13px] tracking-[0.2em] uppercase bg-gold hover:bg-gold-light text-noir px-9 py-4 transition-all duration-500 font-sans font-medium"
          ...
          <Link
            href="#work"
            className="text-[12px] sm:text-[13px] tracking-[0.2em] uppercase text-cream/50 hover:text-cream border border-cream/20 hover:border-cream/40 px-9 py-4 transition-all duration-500 font-sans"
            style={{ borderRadius: "9999px" }}
          >
            View Our Work
          </Link>
