...
function Quote({ children }: { children: ReactNode }) {
  return (
    <RevealOnScroll>
      <div className="max-w-[680px] mx-auto px-6 text-center my-20 sm:my-28">
...
export default function StoryGallery() {
  return (
    <section id="work" className="relative bg-background py-24 sm:py-36 overflow-hidden">
      {/* ── Section opener ─────────────────────────────────────── */}
      <RevealOnScroll>
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 mb-24 sm:mb-32 text-center">
          ...
          <h2 className="font-serif text-foreground text-4xl sm:text-5xl md:text-6xl lg:text-[4.5rem] leading-[1.03] max-w-4xl mx-auto">
            We don&apos;t count weddings
            <br />
            in projects. <span className="italic text-gold-dark">We count them in moments.</span>
          </h2>
          <p className="mt-8 text-cream-dim text-base sm:text-lg font-sans font-light max-w-xl mx-auto leading-relaxed">
            Every day we capture becomes part of one ongoing story — the same quiet eye, the same care, the same love of the in-between. Here&apos;s a slice of it, in no particular order.
          </p>
        </div>
      </RevealOnScroll>

      {/* ── 1. Opening hero frame ──────────────────────────────── */}
      <RevealOnScroll variant="fade">
        <div className="max-w-[1500px] mx-auto px-6 sm:px-10 mb-6">
      ...
      <Quote>It begins quietly &mdash; long before the dress, the rings, the names on the card.</Quote>
      ...
      <Quote>And then &mdash; a look, a laugh, a hand held a little tighter than usual.</Quote>
      ...
      <Quote>Some frames you&apos;ll want on the wall. Most, you&apos;ll want to live inside.</Quote>
      ...
      <Quote>We&apos;re not there to direct your day. We&apos;re there to make sure it doesn&apos;t slip away.</Quote>
